...
catalogo = Catalogo()
# Catalogo de libros
catalogo.agregarLibro(Libro("Cien años de soledad","Novela", "Gabriel García Márquez", 5))
    ...
    while True:
        ...
        if opcion == "1":
            ...
            print("3. Ver opiniones de los libros")
             #El usuario elige una opcion
            opcion5 = input("Selecciona una opcion: ").strip()
            #Si el usuario elige la opcion 1, le mostramos los libros para ver cual desea escoger
            if opcion5=="1":
                print("Que libro deseas calificar?")
                catalogo.mostrarLibrosCalificacion()
                opcion6= input("Ingresa el nombre del libro que deseas: ").strip()
                opcion7= int(input("Ingresa la calificacion que le deseas dar al libro(1 al 5): "))
                opcion8= input("Ingresa la reseña que quieres dar al libro: ").strip()
                catalogo.calificarLibro(opcion6,opcion7,opcion8)

            #Si el usuario elige la opcion 2, le mostramos los libros dependiendo de la categoria que desee    
            elif opcion5=="2":
                print("Mostrando calificaciones de libros")
                catalogo.mostrarCalificacionesPromedio()

            #Si el usuario escoge la opcion 3, le mostramos el catalogo dependiendo del autor o titulo que desee
            elif opcion5=="3":
                print("De que libro deseas ver su reseña?:")
                catalogo.mostrarLibrosCalificacion()
